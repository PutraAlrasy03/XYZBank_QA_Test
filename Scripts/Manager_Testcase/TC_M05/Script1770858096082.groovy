...
WebUI.click(findTestObject('Manager_Obj/Customers/Page_XYZ Bank/button_Customers'))

// 3. SEARCH: Type the name
WebUI.setText(findTestObject('Manager_Obj/Customers/Page_XYZ Bank/input_Search Customer'), customerName)
