...
WebUI.setText(findTestObject('Page_Customer_Dashboard/Page_Customer_List/input_amount'), '100')
...
WebUI.verifyElementPresent(findTestObject('Page_Customer_Dashboard/Page_Customer_List/span_Deposit Successful'), 5)